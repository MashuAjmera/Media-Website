;(function () {
	...
	var SubMenu = function() {
		$("li.menu-item-has-children").on({
			mouseenter: function () {
				$('.sub-menu:first, .children:first, .full-width-sub-menu:first',this).stop(true,true).slideDown('fast');
			},
			mouseleave: function () {
				$('.sub-menu:first, .children:first, .full-width-sub-menu:first',this).stop(true,true).slideUp('fast');
			}
		});
		$("ul.full-width-sub-menu").css("width", $(".container").width());
	};	
